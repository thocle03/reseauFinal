        ...
        <div class="wsk-cp-product">
            ...
            <div class="wsk-cp-text">
                ...
                <div class="card-footer d-flex justify-content-center">
                    ...
                    <?php endif ?>
                    <a href="javascript:;" onclick="toggleCommentForm()" class="btn btn-primary">Nouveau Commentaire</a>
                </div>
                <br>
                <div class="d-flex justify-content-center">
                    <button class="btn btn-success" id="mask">Montrer / Cacher les commentaires</button>
                </div>
                <div id="comments">
